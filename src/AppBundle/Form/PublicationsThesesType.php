    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('dateSoutenance', DateType::class,
            ...
            ->add('abbrevDepartement', TextType::class,
                array('label' => 'Abbréviation du laboratoire', 'required' => false))
            ->add('phdorhdr', ChoiceType::class, array(
                'choices'  => array('Thèse' => 'phd', 'Habilitation' => 'hdr'),
                'expanded' => true,
                'label'    => 'Thèse ou Habilitation'
            ))
            ->add('universite', TextType::class, array('label' => 'Université'))
            ->add('abbrevUniversite', TextType::class,
                array('label' => 'Abbréviation de l\'université', 'required' => false))
