...
class MembresCresticCompletType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('dateNaissance',DateType::class, array('required' => false, 'widget'=> 'single_text', 'format' => 'dd/MM/yyyy', 'attr' => array('placeholder' => 'dd/mm/aaaa'), 'label' => 'Date de naissance'))

            ->add('adresse', TextType::class, array('label' => 'Adresse professionnelle', 'required' => false))
            ->add('site', ChoiceType::class, array('choices' => array(
                'Châlons en Champagne' => 'Châlons en Champagne',
                'Charleville-Mézières' => 'Charleville-Mézières',
                'Reims' => 'Reims',
                'Troyes' => 'Troyes'
            ), 'label' => 'Site du CReSTIC', 'required' => false))
            ...
            ->add('status', ChoiceType::class, array(
                'choices'    => Data::TAB_STATUS_FORM, 'required' => true, 'label' => 'Statut',
            ))
            ->add('cnu', ChoiceType::class, array('choices' => array('61' => '61', '27' => '27'), 'required' => false, 'label' => 'CNU'))

            ->add('hdr', ChoiceType::class, array('label' => 'Titulaire de l\'hdr', 'choices' => array('Oui' => true, 'Non' => false), 'required' => false))
            ...
            ->add('responsabilitesScientifiques', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ->add('responsabilitesAdministratives', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ...
            ->add('valorisation', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ->add('vulgarisation', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ->add('international', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ->add('enseignements', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ->add('responsabiliteFonction', TextareaType::class,array('attr' => array('class' => 'tinyMCE'), 'required' => false))
            ->add('ancienMembresCrestic', ChoiceType::class, array('label' => 'Ancien membre du CReSTIC', 'choices' => array('Oui' => true, 'Non' => false), 'expanded' => true))
            ->add('membreAssocie', ChoiceType::class, array('label' => 'Membre associé', 'choices' => array('Oui' => true, 'Non' => false), 'expanded' => true ))
            ->add('membreConseilLabo', ChoiceType::class, array('label' => 'Membre du conseil de laboratoire', 'choices' => array('Oui' => true, 'Non' => false), 'expanded' => true))
